...
import { Plus, Search, Filter, Eye, Edit, Trash2, Mail, FileText, MoreHorizontal } from 'lucide-react';
...
const mockArInvoices: ArInvoice[] = [
  ...
  {
    id: '2',
    customer_name: 'CV. Retail Maju',
    sales_name: 'Jane Sales',
    invoice_number: 'AR-2026-002',
    order_number: 'SO-2026-002',
    invoice_date: '2025-12-10',
    due_date: '2025-12-25',
    invoice_amount: 180000000,
  ...
  {
    id: '3',
    customer_name: 'PT. Agribisnis Indo',
    sales_name: 'John Sales',
    invoice_number: 'AR-2026-003',
    order_number: 'SO-2026-003',
    invoice_date: '2025-12-20',
    due_date: '2026-01-20',
    invoice_amount: 320000000,
    paid_amount: 0,
  ...
  {
    id: '4',
    customer_name: 'PT. Manufacturing X',
    sales_name: 'Jane Sales',
    invoice_number: 'AR-2026-004',
    order_number: 'SO-2026-004',
    invoice_date: '2025-11-20',
    due_date: '2025-12-20',
    invoice_amount: 150000000,
...
export default function ArListPage() {
  ...
  const filteredInvoices = mockArInvoices.filter(
    (inv) =>
